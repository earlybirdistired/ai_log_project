...
export default function AnalyzePage() {
  ...
  return (
    <div className="min-h-dvh bg-background">
      {/* spacing.container-padding: 24px(px-6/py-6), spacing.gutter: 16px(gap-4) — docs/디자인.md */}
      <div className="mx-auto flex max-w-[1280px] flex-col gap-4 px-6 py-6">
        ...
        {history.length > 0 && (
          <div className="rounded-lg border-2 border-border/70 bg-card/50 p-4">
            ...
            <ol className="flex flex-wrap gap-2">
              {history.map((entry, i) => (
                <li
                  key={i}
                  className="rounded-none border-2 border-border bg-background px-3 py-1 text-xs text-foreground/80"
                >
        ...
        <div className="rounded-lg border-2 border-border/70 bg-card/50 p-4 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-2">
            <button
              ...
              className="inline-flex min-h-8 items-center rounded-md border-2 border-border bg-secondary px-3 py-1 text-xs font-medium text-secondary-foreground transition-colors hover:bg-accent disabled:cursor-not-allowed disabled:opacity-50"
            >
              [E-03] AI 서비스 실패 유발
            </button>
            <button
        ...
        {/* 제품 원칙 푸터 */}
        <footer className="flex flex-col gap-3 border-t-2 border-border pt-6">
