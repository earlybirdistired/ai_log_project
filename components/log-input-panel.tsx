...
export function LogInputPanel({
  ...
  return (
    <section className="flex flex-col border-2 border-primary bg-card">
      <div className="flex flex-col gap-1 border-b-2 border-border p-5">
        ...
        <div className="relative flex items-center justify-between">
          ...
          <div className="relative">
            <button
              ...
              className="inline-flex min-h-9 items-center gap-1.5 rounded-md border-2 border-border bg-secondary px-3 py-1.5 text-xs font-medium text-secondary-foreground transition-colors hover:bg-accent focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-ring disabled:cursor-not-allowed disabled:opacity-50"
            >
            ...
            {showPresets && (
              <div
                role="listbox"
                className="absolute right-0 top-full z-20 mt-1 w-64 border-2 border-primary bg-popover p-1.5 animate-in fade-in-50 zoom-in-95"
              >
...
198.51.100.17 - - [26/Aug/2026:10:14:22 +0900] "GET /search?q=' OR 1=1-- HTTP/1.1" 500 821`}
        ...
        {emptyNotice && (
          <p
            role="alert"
            className="flex items-center gap-1.5 rounded-md border-2 border-destructive/40 bg-destructive/10 px-3 py-2 text-sm text-destructive"
          >
        ...
        {overflowNotice && (
          <p
            role="alert"
            className="flex items-center gap-1.5 rounded-md border-2 border-risk-high/40 bg-risk-high/10 px-3 py-2 text-sm text-risk-high"
          >
            <AlertCircle className="size-4 shrink-0" aria-hidden="true" />
        ...
        <div className="mt-1 flex flex-col gap-3 sm:flex-row">
          ...
          <button
            ...
            onClick={onReset}
            disabled={isAnalyzing}
            className="inline-flex min-h-11 items-center justify-center gap-2 rounded-lg border-2 border-border bg-secondary px-4 py-2.5 text-sm font-medium text-secondary-foreground transition-colors hover:bg-accent focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-ring disabled:cursor-not-allowed disabled:opacity-50"
          >
